...
from .views import UserProfileAPIView, PostListCreateAPIView, PostDetailAPIView, CommentListCreateAPIView, CommentDetailAPIView, LikeListCreateAPIView, LikeDetailAPIView, FriendshipListCreateAPIView, FriendshipDetailAPIView
